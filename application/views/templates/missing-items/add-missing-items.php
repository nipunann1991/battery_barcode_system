<div ng-controller="addMissingCtrl" class="page_inner {{animated_class}}">
	<div class="head">
		<div class="top"> 
			<h2>{{title}}</h2>
		            ...
		            <div class="col-md-6">
			 			<div class="form-group">
						    ...
						    <div class="col-sm-12" ng-class="{ 'has-error' : !addReturnForm.barcode.$pristine && addReturnForm.barcode.$touched && addReturnForm.barcode.$invalid }">
						      <input type="text" class="form-control" id="barcode" name="barcode" ng-model="barcode" ng-change="validateBarcode()"  required>  
