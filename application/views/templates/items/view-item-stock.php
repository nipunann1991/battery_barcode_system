<div ng-controller="ItemsStockCtrl" class="page_inner {{animated_class}}">
	<div class="head">
		...
		<md-button ng-click="openModalAddStock()" ><i class="icon-plus-sign-in-a-black-circle" aria-hidden="true"></i> Add new battery</md-button>
		    ...
		    <tbody>
			    <tr ng-repeat="gis in getSingleIteminStock" > <!-- ng-class="{ 'active_item' : gis.archived ==  '0'}" -->
			        ...
			        <td>
			        	...
			        	<span ng-show="gis.status == '1'" class="label label-success"  >In Stock</span>
			        </td>
